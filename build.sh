...
package_windows() { # Script to prepare the windows exe
    mkdir -p dist
    cp i386-softmmu/qemu-system-i386.exe dist/xboxemu.exe
    cp i386-softmmu/qemu-system-i386w.exe dist/xboxemuw.exe
    python3 ./get_deps.py dist/xboxemu.exe dist
    strip dist/xboxemu.exe
    strip dist/xboxemuw.exe
}
